...
Вводится число N (от 2 до `100_000_000`).

Вывести пары чисел через пробел: простое число и степень этого простого в разложении N (простые числа не больше 10000, или N - простое)

Можете сохранить простые числа до `\sqrt N` в массиве и проверить, делят ли они ваше число.
